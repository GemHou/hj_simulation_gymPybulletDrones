...
RESUME_NAME = "5900X-actionAngRes--20241219-1431"
EPOCH = 500  # 1000 5000 2000
...
def main():
    ...
    env = HjAviaryActionAngRes(gui=False)  # , ctrl_freq=10, pyb_freq=100
    ...
    for epoch in tqdm.tqdm(range(EPOCH)):
        ...
        torch.save(ac.state_dict(), "./data/interim/para_actionAngRes_temp.pt")
